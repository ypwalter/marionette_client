 ...
 * in will get passed to this script as __namedArgs.appframe.
 */
 ...
 */
var frame = __namedArgs.appframe;
is('Messages', frame.contentWindow.document.getElementsByTagName('title')[0].innerHTML);
